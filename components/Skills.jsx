        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 pt-4">
          ...
          <div className="p-6 shadow-md shadow-[#34393f]/40 rounded-xl hover:scale-105 ease-in duration-300">
            <div className="grid grid-cols-2 gap-4 justify-center items-center">
              <div className="m-auto">
                <Image
                  src="/../public/assets/skills/nextauth.png"
                  width="64"
                  height="64"
                  alt="/"
                />
          ...
          <div className="p-6 shadow-md shadow-[#34393f]/40  rounded-xl hover:scale-105 ease-in duration-300">
            <div className="grid grid-cols-2 gap-4 justify-center items-center">
              <div className="m-auto">
                <Image
                  src="/../public/assets/skills/blockchain.png"
                  width="64"
                  height="64"
                  alt="/"
                />
          ...
          <div className="p-6 shadow-md shadow-[#34393f]/40  rounded-xl hover:scale-105 ease-in duration-300">
            <div className="grid grid-cols-2 gap-4 justify-center items-center">
              <div className="m-auto">
                <Image
                  src="/../public/assets/skills/web3.png"
                  width="64"
                  height="64"
                  alt="/"
                />
          ...
          <div className="p-6 shadow-md shadow-[#34393f]/40  rounded-xl hover:scale-105 ease-in duration-300">
            <div className="grid grid-cols-2 gap-4 justify-center items-center">
              <div className="m-auto">
                <Image
                  src="/../public/assets/skills/truffle.png"
                  width="69"
                  height="64"
                  alt="/"
                />
          ...
          <div className="p-6 shadow-md shadow-[#34393f]/40  rounded-xl hover:scale-105 ease-in duration-300">
            <div className="grid grid-cols-2 gap-4 justify-center items-center">
              <div className="m-auto">
                <Image
                  src="/../public/assets/skills/token.png"
                  width="64"
                  height="64"
                  alt="/"
                />
          ...
          <div className="p-6 shadow-md shadow-[#34393f]/40  rounded-xl hover:scale-105 ease-in duration-300">
            <div className="grid grid-cols-2 gap-4 justify-center items-center">
              <div className="m-auto">
                <Image
                  src="/../public/assets/skills/rest.png"
                  width="64"
                  height="64"
                  alt="/"
                />
